...
import CreditCardOutlinedSvg from '../../vendors/asn/CreditCardOutlined';
import AntdIcon, { AntdIconProps } from '../components/AntdIcon';

const CreditCardOutlined = (props: AntdIconProps, ref: React.MutableRefObject<HTMLSpanElement>) => (
